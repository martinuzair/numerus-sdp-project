...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 25, 2024 at 05:41 PM
...
-- Database: `numerus`
--
CREATE DATABASE IF NOT EXISTS `numerus` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `numerus`;
...
(347, 8, 'C 8+0', 0),
(348, 8, 'D 4+3', 0),
(349, 9, 'A 1/9, 1/7, 1/5, 1/3, 1/2', 1),
(350, 9, 'B 1/2, 1/5, 1/3, 1/7, 1/9', 0),
(351, 9, 'C 1/9, 1/5, 1/7, 1/3, 1/2', 0),
(352, 9, 'D 1/2, 1/3, 1/5, 1/7, 1/9', 0),
(353, 10, 'A 25', 0),
(354, 10, 'B 10', 1),
(355, 10, 'C 70', 0),
(356, 10, 'D 40', 0),
...
(22, 'chin@gmail.com', 'Chin Bo Ze', '110314045200', 'male', '2011-03-14', 7),
(23, 'chin1@gmail.com', 'Chin Bo Da', '080808048888', 'male', '2008-08-08', 7),
(24, 'chin2@gmail.com', 'Chin Bo Shao', '888888888888', 'male', '2004-01-15', 7);
...
(7, 'yikwei@gmail.com', 'Ng Yik Wei', '040322140468', 'female', '2004-03-22', '0129720971');
...
(135, 34, 'C 3/10', 1),
(136, 34, 'D 3/8', 0),
(137, 35, 'A Three point four eighty-seven', 0),
(138, 35, 'B Three point four eight seven', 1),
(139, 35, 'C Three and four hundred eighty-six tenths', 0),
(140, 35, 'D Three and four hundred -eight hundredths', 0),
(141, 36, 'A 0.07', 0),
(142, 36, 'B 0.7', 1),
(143, 36, 'C 0.17', 0),
(144, 36, 'D 0.77', 0),
...
(35, 5, 'Convert 3.487 into words.', '2.3.3.gif'),
...
('admin1@gmail.com', 'Admin1', 'Admin'),
('chin1@gmail.com', 'chin1', 'Children'),
('chin2@gmail.com', 'chin2', 'Children'),
('chin@gmail.com', 'chin', 'Children'),
('yikwei@gmail.com', 'yikwei', 'Parent');
...
--
ALTER TABLE `assess_result`
  MODIFY `Aresult_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `child`
  MODIFY `Child_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `child_avatar`
--
ALTER TABLE `child_avatar`
  MODIFY `CAvatar_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT for table `child_progress`
--
ALTER TABLE `child_progress`
  MODIFY `Progress_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `quiz_choice`
  MODIFY `Choice_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;
...
--
ALTER TABLE `result`
  MODIFY `Result_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
('root', '[{\"db\":\"numerus\",\"table\":\"user\"},{\"db\":\"numerus\",\"table\":\"quiz_question\"},{\"db\":\"numerus\",\"table\":\"quiz_choice\"},{\"db\":\"numerus\",\"table\":\"quiz\"},{\"db\":\"numerus\",\"table\":\"assess_choice\"},{\"db\":\"numerus\",\"table\":\"assess_question\"},{\"db\":\"numerus\",\"table\":\"assess\"},{\"db\":\"numerus\",\"table\":\"child_progress\"},{\"db\":\"numerus\",\"table\":\"parent\"},{\"db\":\"numerus\",\"table\":\"child\"}]');
...
('root', '2024-08-21 18:16:01', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":744}');
